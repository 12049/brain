...
// ========== الأمان (CSP معدل لحل مشكلة inline scripts) ==========
app.use(helmet({
    contentSecurityPolicy: {
        directives: {
            ...
            imgSrc: ["'self'", "data:", "https://raw.githubusercontent.com", "https://*.githubusercontent.com", "https://*.vercel.app"],
            connectSrc: ["'self'", "https://api-dataflowx.vercel.app", "https://*.mongodb.net"],
            frameSrc: ["'none'"],
            objectSrc: ["'none'"],
        },
    },
...
app.use(cors({
    origin: ['http://localhost:3000', 'https://braincode-support.vercel.app', 'https://*.vercel.app'],
    credentials: true
}));
    ...
    try {
        ...
        if (!adminExists && process.env.ADMIN_PASSWORD) {
            ...
            const admin = new User({
                username: process.env.ADMIN_USERNAME || 'braincode_admin',
